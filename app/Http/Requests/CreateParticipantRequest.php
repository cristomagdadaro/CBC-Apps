...
class CreateParticipantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'city_address' => ['nullable', 'string', 'in:loc_cities,city'],
            'province_address' => ['nullable', 'string', 'in:loc_cities,province'],
            'region_address' => ['nullable', 'string', 'in:loc_cities,region'],
            'country_address' => ['nullable', 'string'],
            'agreed_tc' => ['required', 'accepted'],
            'agreed_updates' => ['nullable', 'boolean'],
