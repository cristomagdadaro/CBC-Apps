    ...
    <form v-if="form" @submit.prevent="handleCreate()" class="px-2 py-4  md:rounded-md flex flex-col gap-2 bg-white max-w-xl drop-shadow-lg">
        ...
        <div class="flex flex-col gap-3 text-sm leading-tight text-justify">
            ...
            <div class="flex items-center gap-1" title="Require guests to pre-register">
                ...
                >
                <span>I hereby acknowledge that I will utilize the supply/equipment/laboratory at my own risk; and agree to use it responsibly and in accordance with any provided instructions or safety guidelines.</span>
            </div>
            <div class="flex items-center gap-1" title="Require guests to pre-register">
                <input
                    type="checkbox"
                ...
                >
                <span>I agree to assume full responsibility for any damage or loss of the equipment while it is in my possession. </span>
            </div>
            <div class="flex items-center gap-1" title="Require guests to pre-register">
                <input
                    type="checkbox"
