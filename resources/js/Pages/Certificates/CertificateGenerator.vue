            ...
            <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 overflow-hidden transition-all duration-300">
                ...
                <div class="p-6">
                    <div v-if="!selectedEventId" class="space-y-4">
                        <div>
                            <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2.5">
                                Event ID
                            </label>
                            ...
                            <p class="mt-2.5 text-xs font-medium text-slate-500 dark:text-slate-400">
                        ...
                        <Transition
                            ...
                            <div v-if="errorMessage" class="flex items-center gap-2 p-3 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-xl text-red-700 dark:text-red-400 text-sm font-semibold shadow-sm">
                    ...
                    <div v-else class="flex items-center justify-between p-5 bg-indigo-50/80 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/30 rounded-2xl shadow-sm backdrop-blur-md">
