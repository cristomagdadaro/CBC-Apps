                ...
                <CRCMDatatable
                    ...
                    <template #cell-public_url="{ row, value }">
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            class="text-emerald-600 dark:text-emerald-400 font-medium hover:underline underline-offset-2">
                    ...
                    <template #cell-target_url="{ value }">
                        <a
                            ...
                            target="_blank"
                            rel="noopener"
                            class="text-slate-600 dark:text-slate-300 font-medium hover:underline underline-offset-2 truncate block max-w-xs">
                            {{ value }}
                        </a>
                    </template>
                    <template #cell-status="{ value }">
                        <span
                            ...
                            :class="value ? 'bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30' : 'bg-rose-50 text-rose-700 border border-rose-200 dark:bg-rose-500/10 dark:text-rose-400 dark:border-rose-500/30'">
