        ...
        <transition-container type="slide-top">
            <div
                ...
                <div class="flex w-full flex-col gap-0.5 text-center">
                    <div class="mb-1 flex w-full flex-col justify-center gap-1 bg-AB py-2 text-xl">
                    ...
                    <span class="font-light leading-none drop-shadow">Registration Successful!</span>
