    ...
    <div class="relative">
        ...
        <div
            ...
            :class="{
                ...
                'border-red-500 bg-red-50 dark:border-red-600 dark:bg-red-900/10': error,
                'border-gray-300 bg-white hover:border-gray-400 dark:border-gray-600 dark:bg-gray-800 dark:hover:border-gray-500': !isDragging && !error,
            }"
            ...
            <div
                ...
                <button
                    ...
                    class="ml-2 text-red-500 transition-colors hover:text-red-700 dark:text-red-400 dark:hover:text-red-300">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-4 w-4"
                        fill="none"
            ...
            <div
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Max size: {{ maxSizeFormatted }}</p>
            </div>
        </div>
