    ...
    <form
        ...
        <div class="pb-3 pt-1">
            ...
            <p class="text-sm leading-tight">
                Tell us where you're studying and whether you'd like to compete in tomorrow's biotech quiz bee. Fields marked with
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="grid grid-cols-3 gap-2">
                ...
                <div
                    ...
                    class="relative flex w-full flex-col-reverse items-center rounded-md border border-gray-600 bg-white px-2 py-0.5 text-center leading-none lg:flex-row lg:gap-2"
            ...
            <div class="flex flex-col gap-2">
                ...
                <div
                    :class="{ 'border-red-500': form.errors.join_quiz_bee }"
                    class="relative flex items-center gap-3 rounded-md border border-gray-600 bg-white px-3 py-2"
                    @click.prevent="form.response_data.join_quiz_bee = !form.response_data.join_quiz_bee">
                    <Checkbox
                        id="join_quiz_bee"
                        v-model="form.response_data.join_quiz_bee"
                        :checked="form.response_data.join_quiz_bee"
                        autocomplete="join_quiz_bee" />
                    ...
                    <transition-container type="slide-bottom">
                        <InputError
                            v-show="!!form.errors.join_quiz_bee"
                            class="absolute -top-1 left-3"
                            :message="form.errors.join_quiz_bee" />
                    </transition-container>
                </div>
                <div
                    v-if="form.hasErrors"
