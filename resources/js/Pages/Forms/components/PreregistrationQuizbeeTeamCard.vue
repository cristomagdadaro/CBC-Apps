        ...
        buildFormData() {
            ...
            Object.entries(responseData).forEach(([key, value]) => {
                ...
                if (value instanceof Date) {
                    formData.append(`response_data[${key}]`, value.toISOString().slice(0, 19).replace("T", " "));
                    return;
                }
                if (typeof value === "object") {
                    formData.append(`response_data[${key}]`, JSON.stringify(value));
                    return;
                }

                if (typeof value === "boolean") {
                    formData.append(`response_data[${key}]`, value ? "1" : "0");
                    return;
                }
    ...
    <form
        ...
        <div class="pb-3 pt-1">
            ...
            <p class="text-sm leading-tight">
                Provide the team and coach details for quiz bee participation. Fields marked with
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="grid grid-cols-2 gap-2">
                <custom-dropdown
                    ...
                    :withAllOption="false"
                    :options="[
                        { name: 'Grade 11', label: 'Grade 11' },
                        { name: 'Grade 12', label: 'Grade 12' },
                    ]">
                    <template #icon>
                        <svg
                            class="ms-2 -me-0.5 h-4 w-4"
