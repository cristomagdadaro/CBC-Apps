                            ...
                            <div class="flex flex-col gap-4 md:flex-row md:items-end w-full">
                                ...
                                <div class="flex-1 md:max-w-xs">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select
                                            v-model="scanType"
                                            class="block w-full pl-10 pr-10 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm font-semibold text-slate-700 dark:text-slate-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm transition-all appearance-none">
                                            <option
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div :class="['rounded-2xl border p-5 transition-colors duration-300 shadow-sm flex flex-col justify-center min-h-[140px]', statusClass]">
                                <div class="flex items-start gap-4">
                                    <component
                                        :is="statusIcon"
                                        class="w-8 h-8 mt-1 shrink-0 opacity-90" />
                                    <div>
                                        ...
                                        <p
                                            class="text-sm font-semibold mt-1.5 opacity-90"
                                            v-if="statusDetail">
                                            {{ statusDetail }}
                                        </p>
                                    </div>
                            ...
                            <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-800/40 p-5 shadow-sm flex-1">
                                ...
                                <div
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p
                                            class="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-0.5 truncate"
                                            v-if="lastScan?.registration?.organization">
                                            {{ lastScan.registration.organization }}
                                        </p>
                                        <div
                                            class="mt-2.5 inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm"
                                            v-if="lastScan?.registration?.id">
                                            <LuHash class="w-3 h-3 text-slate-400" />
                                            <span class="text-[0.65rem] font-bold text-slate-600 dark:text-slate-300 uppercase tracking-widest">
                                ...
                                <div
                                    v-else
                                    class="flex flex-col items-center justify-center h-full text-slate-400 dark:text-slate-500 opacity-70 pb-4">
