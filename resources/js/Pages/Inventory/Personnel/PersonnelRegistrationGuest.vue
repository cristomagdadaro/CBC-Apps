...
<template>
    ...
    <guest-form-page
        ...
        <transition-container
            ...
            :duration="800"
            type="slide-bottom">
            <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-100 dark:border-slate-800 overflow-hidden">
                <div
                    v-if="submitted"
                    class="p-8">
                    <div class="rounded-xl border border-green-200 bg-green-50 p-6 text-green-900 text-center flex flex-col items-center">
                        ...
                        <Link
                            href="/"
                            class="inline-flex mt-6 rounded-lg bg-AB px-6 py-3 text-sm font-semibold text-white hover:bg-AB/90 transition shadow-sm">
                            Return to services
                        </Link>
                    </div>
                </div>
                    ...
                    <form
                        ...
                        <transition
                            ...
                            <div
                                v-if="currentStep === 1"
                                key="step1"
                                class="p-6 sm:p-10 flex flex-col items-center justify-center min-h-[400px]">
                                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8">Select your personnel category</h3>
                                ...
                                <div class="grid grid-cols-2 gap-4 sm:gap-6 w-full max-w-3xl">
                                    <button
                                        ...
                                        :class="form.is_philrice_employee === true ? 'border-AB bg-emerald-50/50 dark:bg-emerald-900/20 shadow-md' : 'border-gray-200 dark:border-slate-700 hover:border-AB/50 hover:bg-gray-50/50 dark:hover:bg-slate-800/50 hover:shadow-md bg-white/50 dark:bg-slate-800/30'">
                                        <div class="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-800/60 transition-all duration-300">
                                            <svg
                                        ...
                                        <h4 class="text-sm sm:text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3">PhilRice Employee</h4>
                                        <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Regular staff, contract of service, or direct hires of DA-PhilRice.</p>
                                    </button>
                                    ...
                                    <button
                                        ...
                                        class="flex flex-col items-center justify-center p-4 sm:p-10 text-center rounded-2xl border-2 transition-all duration-300 group"
                                        :class="form.is_philrice_employee === false ? 'border-blue-500 bg-blue-50/50 dark:bg-blue-900/20 shadow-md' : 'border-gray-200 dark:border-slate-700 hover:border-blue-400/50 hover:bg-gray-50/50 dark:hover:bg-slate-800/50 hover:shadow-md bg-white/50 dark:bg-slate-800/30'">
                                        <div class="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/60 transition-all duration-300">
                                            <svg
                                                class="w-6 h-6 sm:w-10 sm:h-10"
                                                fill="none"
                                                stroke="currentColor"
                                        ...
                                        <h4 class="text-sm sm:text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3">Student / OJT / Guest</h4>
                                        <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 leading-relaxed">On-the-job trainees, thesis students, and other external researchers.</p>
                                    </button>
                                </div>
                            </div>
                        </transition>
                        ...
                        <transition
                            ...
                            <div
                                ...
                                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Personal Details</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">Enter your legal name and contact information.</p>
                                ...
                                <div class="mt-12 flex justify-between border-t border-gray-100 dark:border-slate-800 pt-6">
                                    <button
                                        type="button"
                                        @click="prevStep"
                                        class="px-6 py-2.5 rounded-xl border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-slate-800 transition shadow-sm">
                                        Back
                                    </button>
                                    <button
                                        type="button"
                                        @click="validateStep2"
                                        class="px-8 py-2.5 rounded-xl bg-AB text-white font-bold shadow-md hover:bg-AB/90 transition hover:-translate-y-0.5">
                                        Next Step
                                    </button>
                                </div>
                            </div>
                        ...
                        <transition
                            ...
                            <div
                                ...
                                key="step3_internal"
                                class="p-6 sm:p-10 flex flex-col min-h-[400px]">
                                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Employee Information</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">Provide your DA-PhilRice credentials.</p>

                                <div class="grid md:grid-cols-2 gap-6 bg-gray-50/50 dark:bg-slate-800/50 p-6 rounded-2xl border border-gray-100 dark:border-slate-800">
                                    <text-input
                                        required
                                        label="Position / Role"
                                ...
                                <div class="mt-12 flex justify-between border-t border-gray-100 dark:border-slate-800 pt-6">
                                    ...
                                    <submit-btn
                                        class="px-8 py-2.5 rounded-xl bg-AB text-white font-bold shadow-md hover:bg-AB/90 transition text-base hover:-translate-y-0.5"
                                        :disabled="processing || model.api.processing">
                        ...
                        <transition
                            ...
                            <div
                                ...
                                key="step3_external"
                                class="p-6 sm:p-10 flex flex-col min-h-[400px]">
                                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Registration Requirements</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">Provide details to generate your temporary CBC ID card.</p>
                                ...
                                <div class="grid md:grid-cols-[1fr_14rem] gap-8">
                                        ...
                                        <div class="grid md:grid-cols-2 gap-5">
                                            <div class="space-y-1.5">
                                                ...
                                                <select
                                                    ...
                                                    class="w-full rounded-xl border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white text-sm shadow-sm focus:border-AB focus:ring-AB h-11">
                                                    <option
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        <div class="aspect-square w-full max-w-[14rem] overflow-hidden rounded-2xl border-2 border-dashed border-gray-300 dark:border-slate-600 bg-gray-50/50 dark:bg-slate-800/50 flex items-center justify-center relative group shadow-inner transition-colors hover:border-AB/50">
                                            <img
                                            ...
                                            <div
                                                v-else
                                                class="flex flex-col h-full w-full items-center justify-center p-6 text-center text-gray-400 dark:text-gray-500 group-hover:text-AB transition-colors">
                                                <div class="w-12 h-12 rounded-full bg-white dark:bg-slate-700 shadow-sm flex items-center justify-center mb-3">
                                                    <svg
                                                        class="w-6 h-6"
                                                        fill="none"
                                                        stroke="currentColor"
