                    ...
                    <form @submit.prevent="submitRegistration" class="relative overflow-hidden min-h-[400px]">
                        ...
                        <transition name="slide-fade" mode="out-in">
                            <div v-if="currentStep === 2" key="step2" class="p-6 sm:p-10 flex flex-col min-h-[400px]">
                                ...
                                <div class="mt-12 flex justify-between border-t border-gray-100 dark:border-slate-800 pt-6">
                                    <button type="button" @click="prevStep" class="px-6 py-2.5 rounded-xl border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-slate-800 transition shadow-sm">
                                        Back
                                    </button>
                        ...
                        <transition name="slide-fade" mode="out-in">
                            <div v-if="currentStep === 3 && isPhilRiceEmployee" key="step3_internal" class="p-6 sm:p-10 flex flex-col min-h-[400px]">
                                ...
                                <div class="mt-12 flex justify-between border-t border-gray-100 dark:border-slate-800 pt-6">
                                    <button type="button" @click="prevStep" class="px-6 py-2.5 rounded-xl border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-slate-800 transition shadow-sm" :disabled="processing || model.api.processing">
                                        Back
                                    </button>
                            ...
                            <div v-if="currentStep === 3 && !isPhilRiceEmployee" key="step3_external" class="p-6 sm:p-10 flex flex-col min-h-[400px]">
                                ...
                                <div class="grid md:grid-cols-[1fr_14rem] gap-8">
                                    <div class="space-y-5">
                                        <div class="grid md:grid-cols-2 gap-5">
                                            <div class="space-y-1.5">
                                                ...
                                                <select v-model="form.registration_type" class="w-full rounded-xl border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white text-sm shadow-sm focus:border-AB focus:ring-AB h-11">
                                    ...
                                    <div class="flex flex-col items-center">
                                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">2x2 ID Picture <b class="text-red-500">*</b></label>
                                        <div class="aspect-square w-full max-w-[14rem] overflow-hidden rounded-2xl border-2 border-dashed border-gray-300 dark:border-slate-600 bg-gray-50/50 dark:bg-slate-800/50 flex items-center justify-center relative group shadow-inner transition-colors hover:border-AB/50">
                                            ...
                                            <div v-else class="flex flex-col h-full w-full items-center justify-center p-6 text-center text-gray-400 dark:text-gray-500 group-hover:text-AB transition-colors">
