<script>
export default {
    name: "PersonnelRegistrationVerified",
    props: {
        registration: {
            type: Object,
            required: true,
...
<template>
    <Head title="Personnel Email Verified" />
        ...
        <div class="md:rounded-lg border border-slate-100 bg-white p-6 w-full">
            <div class="flex flex-col items-center text-center w-full">
                ...
                <p class="mt-2 text-sm leading-relaxed text-slate-600">
                    ...
                    ) has been successfully verified. Your status is currently
                    <span class="inline-flex items-center rounded bg-amber-50 px-1.5 py-0.5 text-xs font-medium text-amber-800 ring-1 ring-inset ring-amber-600/20">
                        {{ registration.status }}
                    </span>
