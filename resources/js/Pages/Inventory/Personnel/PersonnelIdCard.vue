<template>
    <section
        ...
        <img
            ...
            alt="Overlay"
            class="absolute top-0 right-0 h-[2cm] pointer-events-none z-0 mix-blend-multiply object-cover object-right-top" />
        ...
        <header class="p-[10px_10px_6px_10px] flex items-center gap-1 z-10 relative">
            ...
            <div class="flex flex-col flex-1 leading-tight">
                <div class="text-[6px] text-slate-800 leading-[7px]">Department of Agriculture</div>
                <div class="text-[8px] font-bold text-[#4CAF50] uppercase leading-[9px] tracking-tight">CROP BIOTECHNOLOGY CENTER</div>
                <div class="text-[5px] text-slate-600 leading-[6px] mt-[1px]">DA-PhilRice Compound, Muñoz, Nueva Ecija</div>
            </div>
        </header>
        ...
        <div class="flex-grow flex flex-col items-center relative z-10">
            ...
            <div class="flex flex-col relative w-full items-center justify-center my-3.5">
                ...
                <div class="z-10 relative bg-white rounded-full border-[5px] border-white">
                    <img
                        ...
                        :src="card.photo_url"
                        alt="Personnel Photo"
                        class="w-[2.6cm] h-[2.6cm] rounded-full border-[2px] border-[#559E47] object-cover block bg-slate-50" />
                    <div
                        v-else
                        class="w-[2.6cm] h-[2.6cm] rounded-full border-[2px] border-[#559E47] block bg-slate-100 flex items-center justify-center">
                        <svg
            ...
            <div class="px-[12px] w-full flex flex-col flex-grow">
                <div class="text-center w-full mb-2 flex flex-col items-center shrink-0">
                    <h2
                        class="text-[12px] font-extrabold text-slate-900 m-0 mb-[3px] uppercase leading-tight break-words line-clamp-2 w-full"
                ...
                <div
                    ...
                    class="text-center w-full mb-2 flex flex-col items-center shrink-0 opacity-30 leading-tight my-auto">
                ...
                <dl class="mt-auto w-full flex flex-col gap-1.5 shrink-0 pb-1.5">
                    <div class="flex justify-between items-end border-b border-dashed border-slate-200 pb-0.5">
                        ...
                        <dd
                            class="text-[9px] font-bold text-slate-800 m-0 truncate text-right max-w-[60%]"
                    ...
                    <div
                        ...
                        class="flex justify-between items-end border-b border-dashed border-slate-200 pb-0.5">
                        <dt class="text-[7px] font-bold text-slate-500 uppercase m-0">Affiliation</dt>
                        <dd
                            class="text-[9px] font-bold text-slate-800 m-0 truncate text-right max-w-[65%]"
                            :title="card.affiliation">
                            {{ card.affiliation }}
                        </dd>
                    </div>
                    <div
                        class="flex justify-between items-end pb-0.5"
        ...
        <footer class="p-[6px_10px] bg-slate-50 relative z-10 flex flex-col">
            <div class="flex items-center justify-between my-[2px]">
                <div class="flex flex-col gap-[1px]">
                    <h3 class="text-[8px] m-0 font-bold text-[#4CAF50] text-left leading-tight">Biotech for Better Crop for Better Lives</h3>
                    <div class="text-[6px] text-left text-slate-800 opacity-70 leading-[5px] max-w-[80%]">dacbc.philrice.gov.ph</div>
                </div>
