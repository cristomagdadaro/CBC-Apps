...
export default defineComponent({
    ...
    mounted() {
        this.api =new CoreApi(route('api.inventory.items.store'));
    },
    computed: {
        suppliers() {
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight uppercase">Register New Item</h2>
        </template>
        <div class="py-4">
