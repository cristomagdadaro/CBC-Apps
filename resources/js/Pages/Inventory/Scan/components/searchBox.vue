    ...
    <div class="flex flex-col gap-1">
        ...
        <div class="relative">
            <div v-if="modelValue" @click="clearSearch" class="absolute right-0 h-full flex items-center justify-center" >
                <close-icon class="w-7 h-auto text-gray-600 mr-3 hover:bg-gray-100 rounded hover:scale-110 duration-100 active:scale-100" @click="$emit('update:modelValue', '')"></close-icon>
            </div>
