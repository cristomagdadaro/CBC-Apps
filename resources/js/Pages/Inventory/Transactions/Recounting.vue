        ...
        <div class="min-h-screen bg-slate-50 dark:bg-slate-950 px-3 sm:px-6 py-4 sm:py-6 text-slate-900 dark:text-slate-100">
            <div class="max-w-7xl mx-auto space-y-4 sm:space-y-6">
                ...
                <transition-group name="fade">
                    <div v-if="successMessage" key="success" class="flex items-center gap-3 p-4 rounded-2xl border border-emerald-200 dark:border-emerald-900/60 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-900 dark:text-emerald-200 shadow-xs">
                    ...
                    <div v-if="errorMessage" key="error" class="flex items-center gap-3 p-4 rounded-2xl border border-rose-200 dark:border-rose-900/60 bg-rose-50 dark:bg-rose-950/40 text-rose-900 dark:text-rose-200 shadow-xs">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
                    ...
                    <div class="lg:col-span-5 space-y-5">
                        ...
                        <!-- Quick Stats -->
                        <div v-if="hasLookupResult" class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-5 shadow-xs">
                    ...
                    <div class="lg:col-span-7">
                        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-xs min-h-[480px]">
                            ...
                            <div class="p-4 sm:p-6">
                                <div v-if="hasLookupResult" class="space-y-5">
                                    <!-- Item Info Cards -->
                                        ...
                                        <div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800">
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <p class="font-bold text-slate-900 dark:text-slate-100 text-sm truncate">{{ lookupResult.name }}</p>
                                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">{{ lookupResult.brand || 'No brand specified' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800">
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <p class="font-bold text-slate-900 dark:text-slate-100 text-xl sm:text-2xl">{{ systemCount }}</p>
                                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">{{ lookupResult.unit || 'units' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                        ...
                                        >
                                            <div class="flex items-center gap-1.5 mb-1">
                                                <TrendingUp v-if="adjustmentType === 'incoming'" class="w-4 h-4" />
                                                <TrendingDown v-else-if="adjustmentType === 'outgoing'" class="w-4 h-4" />
