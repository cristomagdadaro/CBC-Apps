        ...
        <div
            ...
            <div class="flex justify-between items-start gap-3 h-full">
                ...
                <div class="text-right shrink-0">
                    <span class="px-2 py-1 rounded-lg text-xs font-extrabold bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700">{{ formatNumber(item.remaining_quantity) }} {{ item.unit || "" }}</span>
                </div>
            </div>
        </div>
    </div>
