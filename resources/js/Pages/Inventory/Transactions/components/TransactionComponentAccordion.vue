        ...
        <div
            ...
            <div
                ...
                <div class="flex items-start justify-between gap-3 mb-3">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <span class="font-bold text-xs sm:text-sm text-slate-900 dark:text-slate-100 truncate">{{ component?.item?.brand }} {{ component?.item?.description }}</span>
                        </div>
                        <div class="flex flex-wrap items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 ml-6">
                            <span
                                v-if="component?.item?.name"
                                class="flex items-center gap-1 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 font-medium">
                                {{ component.item.name }}
                            </span>
                            <span
                                v-if="component?.barcode"
                                class="flex items-center gap-1 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 font-mono">
                            ...
                            <span
                                ...
                                class="flex items-center gap-1 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 font-bold">
                ...
                <div
                    ...
                    class="ml-6 mt-2 p-2.5 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900/60 rounded-xl">
