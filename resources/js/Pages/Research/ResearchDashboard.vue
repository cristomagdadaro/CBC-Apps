    ...
    computed: {
        statCards() {
            return [
                ...
                {
                    label: "Experiments",
                    value: this.stats.experiments || 0,
                    icon: "LuFlaskConical",
                    ...
                    <div class="p-6">
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="rounded-lg bg-slate-50 p-4 ring-1 ring-slate-200">
                                ...
                                <code class="mt-2 block text-lg font-semibold text-slate-900">
                                    {{ sampleIdentifierExample || "RS-2024-0001" }}
                                </code>
                ...
                <div class="rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
                    ...
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                            <span
                                v-for="commodity in commodityPreview"
                                :key="commodity"
                            ...
                            <span
                                v-if="(catalog.commodities || []).length > 6"
                        ...
                        <div class="mt-4 rounded-lg bg-amber-50 p-3 ring-1 ring-amber-100">
                            <p class="text-xs text-amber-800">
                                ...
                                Rice-optimized fields with cross-commodity support for broader research programs.
                            </p>
                        </div>
                    </div>
                </div>
