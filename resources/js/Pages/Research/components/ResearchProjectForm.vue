            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <input
                        ...
                        placeholder="e.g., Drought Resistance Marker-Assisted Breeding" />
                    <p
                ...
                <div>
                    ...
                    <p
                        v-if="form.errors.overall_budget"
                        class="mt-1 text-xs text-red-600">
                        {{ form.errors.overall_budget }}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input
                        v-model="form.funding_agency"
                        class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        placeholder="e.g., DA-BAR" />
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-700">Grant Code</label>
                    <input
                        v-model="form.funding_code"
                        class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        placeholder="e.g., RTF-000-000" />
                </div>
                ...
                <div>
                    ...
                    <p
                        v-if="form.errors.project_leader_id"
                        class="mt-1 text-xs text-red-600">
                        {{ form.errors.project_leader_id }}
                    </p>
                </div>
