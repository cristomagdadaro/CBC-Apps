    ...
    methods: {
        ...
        async submitProxy() {
            ...
            if (response instanceof DtoResponse) {
                const experimentIdentifier = this.routeExperimentIdentifier(response?.data?.data) ?? this.experimentRouteIdentifier;
...
<template>
    <form
        v-if="form"
        class="space-y-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm"
        ...
        <div class="flex flex-wrap items-start justify-between gap-4 border-b border-gray-100 pb-5">
            <div>
                ...
                <h2 class="mt-2 text-2xl font-semibold text-gray-900">
                    {{ isEdit ? "Experiment update form" : "Create study experiment" }}
                </h2>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Field site or station" />
                <p
                    v-if="fieldError('geographic_location')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("geographic_location") }}
                </p>
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    class="w-full rounded-xl border-gray-300">
                    <option
                        v-for="season in catalog.seasons || []"
                        :key="season.value"
                        :value="season.value">
                        {{ season.label }}
                    </option>
            ...
            <div>
                ...
                <input
                    ...
                    list="research-experiment-form-commodity-options"
                    class="w-full rounded-xl border-gray-300" />
                <p
                    v-if="fieldError('commodity')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("commodity") }}
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    list="research-experiment-form-sample-options"
                    class="w-full rounded-xl border-gray-300" />
                <p
                    v-if="fieldError('sample_type')"
                    class="mt-1 text-xs text-red-600">
            ...
            <div>
                ...
                <input
                    v-model="form.sample_descriptor"
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Ex. NSIC Rc222 / WEG1" />
                <p
                    v-if="fieldError('sample_descriptor')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("sample_descriptor") }}
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Ex. BC1F1" />
                <p
                    v-if="fieldError('generation')"
                    class="mt-1 text-xs text-red-600">
            ...
            <div>
                ...
                <input
                    v-model="form.filial_generation"
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Ex. F2" />
                <p
                    v-if="fieldError('filial_generation')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("filial_generation") }}
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full rounded-xl border-gray-300" />
                <p
                    v-if="fieldError('plot_number')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("plot_number") }}
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    v-model="form.field_number"
                    class="w-full rounded-xl border-gray-300" />
                <p
                    v-if="fieldError('field_number')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("field_number") }}
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    v-model="form.replication_number"
                    type="number"
                    min="1"
                    class="w-full rounded-xl border-gray-300" />
                <p
                    v-if="fieldError('replication_number')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("replication_number") }}
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    v-model="form.planned_plant_count"
                    type="number"
                    min="0"
                    class="w-full rounded-xl border-gray-300" />
                <p
                    v-if="fieldError('planned_plant_count')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("planned_plant_count") }}
                </p>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input
                    v-model="form.cross_combination"
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Ex. WEG1 x NSIC Rc160" />
                <p
                    v-if="fieldError('cross_combination')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("cross_combination") }}
                </p>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea
                    v-model="form.parental_background"
                    rows="3"
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Background, lineage, or source notes" />
                <p
                    v-if="fieldError('parental_background')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("parental_background") }}
                </p>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea
                    v-model="form.background_notes"
                    rows="3"
                    class="w-full rounded-xl border-gray-300"
                    placeholder="Add new variety, trait, or trial-specific notes" />
                <p
                    v-if="fieldError('background_notes')"
                    class="mt-1 text-xs text-red-600">
                    {{ fieldError("background_notes") }}
                </p>
            </div>
        </div>
