    ...
    computed: {
        ...
        headerBreadcrumbs() {
            return [
                ...
                {
                    label: this.study.project?.funding_code || this.study.project?.code || "Project",
        ...
        <template #header>
            <ActionHeaderLayout
                ...
                <Link
                    ...
                    :href="route('research.experiments.create', studyRouteIdentifier)"
            ...
            <div class="rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 px-6 py-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <span class="inline-flex items-center rounded-full bg-slate-100 px-3 py-1 text-xs font-medium text-slate-700">{{ study.experiments_count || 0 }} experiments</span>
                        <button
                    ...
                    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-semibold text-slate-900">
                                ...
                                <span
                                    v-if="study.study_leader?.position"
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-semibold text-slate-900">
                                ...
                                <span
                                    v-if="study.supervisor?.position"
                                    class="block text-xs font-normal text-slate-500">
