    ...
    <AppLayout title="Research Projects">
        ...
        <div class="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8">
            ...
            <div
                ...
                class="flex flex-col items-center justify-center rounded-xl bg-white py-16 shadow-sm ring-1 ring-slate-200">
            ...
            <div
                ...
                <Link
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <span class="ml-2 inline-flex flex-none items-center rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-700">{{ project.studies_count }} studies</span>
                    </div>
                    ...
                    <div class="mt-6 border-t border-slate-100 pt-4">
                        ...
                        <div
                            v-for="study in (project.studies || []).slice(0, 2)"
                            :key="study.id"
