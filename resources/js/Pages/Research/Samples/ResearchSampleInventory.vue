    ...
    <div class="space-y-6 px-4 py-6">
      ...
      >
        ...
        <p class="mt-2 text-sm text-gray-600">
          Use barcode for audit/inventory workflows and QR for retrieval, printing, and
          presentation view.
        </p>
        <div class="mt-4">
          <CameraScanner
      ...
      <section class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div
          ...
          class="mt-4 rounded-2xl border border-dashed border-gray-300 p-8 text-center text-sm text-gray-500"
        >
          ...
          <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
              <tr v-for="sample in samples" :key="sample.id">
                ...
                <td class="px-3 py-3">
                  <svg
                    :id="`research-sample-barcode-${sample.id}`"
                    class="h-12 w-40"
                  ></svg>
                </td>
                <td class="px-3 py-3">
                  <QrcodeVue
                    :value="qrPayload(sample)"
                    :size="56"
                    level="M"
                    render-as="canvas"
                  />
