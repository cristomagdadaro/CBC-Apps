...
<template>
  <AppLayout title="System Manuals">
    <template #header>
      <ActionHeaderLayout
        :title="
          showDeveloperSections ? 'System Manuals & Guides' : 'Public Manuals & Guides'
        "
        :subtitle="
          showDeveloperSections
            ? 'Comprehensive guides to help you navigate and utilize the system effectively.'
            : 'Step-by-step user guides for public visitors and operational staff.'
        "
      />
    </template>
