...
<template>
    <TopicLayout
        ...
        <div
            ...
            class="space-y-6">
            <p class="text-sm font-medium text-slate-700 dark:text-slate-300 leading-relaxed">The Rental Services Module provides a comprehensive system for managing vehicle rentals, venue bookings, and hostel accommodations with built-in conflict detection, real-time availability checking, and complete status tracking[cite: 5].</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2.5 text-xs font-medium text-slate-700 dark:text-slate-300">
                        ...
                        <li class="flex items-start gap-2.5">
                            <LuBuilding class="w-4 h-4 text-indigo-500 shrink-0 mt-0.5" />
                            <span>
                        ...
                        <li class="flex items-start gap-2.5">
                            <LuMapPin class="w-4 h-4 text-indigo-500 shrink-0 mt-0.5" />
                            <span>
                ...
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2.5 text-xs font-medium text-slate-700 dark:text-slate-300">
                        <li class="flex items-start gap-2.5">
                            <LuCheckCircle2 class="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
        ...
        <div
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-blue-50/50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 rounded-xl p-5 shadow-sm">
                    ...
                    <p class="text-[0.65rem] font-medium text-blue-700 dark:text-blue-400/90 leading-relaxed">Sophisticated date range logic prevents overlapping bookings for the same resource[cite: 5]. Only approved and pending bookings are considered as blocking[cite: 5].</p>
                </div>
                ...
                <div class="bg-emerald-50/50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 rounded-xl p-5 shadow-sm">
                    ...
                    <p class="text-[0.65rem] font-medium text-emerald-700 dark:text-emerald-400/90 leading-relaxed">Forms check availability instantly before submission[cite: 5]. Submit button remains disabled until the requested dates are confirmed available[cite: 5].</p>
                </div>
                ...
                <div class="bg-purple-50/50 dark:bg-purple-500/10 border border-purple-100 dark:border-purple-500/20 rounded-xl p-5 shadow-sm">
                    ...
                    <p class="text-[0.65rem] font-medium text-purple-700 dark:text-purple-400/90 leading-relaxed">Each booking moves through a lifecycle: pending → approved/rejected → completed/cancelled, with full audit trail via soft deletes[cite: 5].</p>
                </div>
                ...
                <div class="bg-amber-50/50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 rounded-xl p-5 shadow-sm">
                    <h5 class="text-xs font-semibold text-amber-800 dark:text-amber-300 mb-2 flex items-center gap-2">
                        <LuCheckSquare class="w-4 h-4" />
                        Form Validation
                    </h5>
                    <p class="text-[0.65rem] font-medium text-amber-700 dark:text-amber-400/90 leading-relaxed">Multi-layer validation: dates cannot be in the past, times must have end after start, contact numbers must match specific formats, and more[cite: 5].</p>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">innova</code>
                            Toyota Innova[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">pickup</code>
                            Pickup Truck[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">van</code>
                            Van[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">suv</code>
                            SUV[cite: 5]
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-amber-500">pending</code>
                            Awaiting approval[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-emerald-500">approved</code>
                            Confirmed and ready[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-rose-500">rejected</code>
                            Request denied[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-blue-500">completed</code>
                            Rental finished[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-slate-500">cancelled</code>
            ...
            <div class="bg-indigo-50/50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl p-5 shadow-sm">
                ...
                <p class="text-xs font-medium text-slate-600 dark:text-slate-400 mb-3">
                    Navigate to
                    <code class="font-mono bg-white dark:bg-slate-800 px-1 py-0.5 rounded shadow-sm text-indigo-500">/rental/vehicle</code>
                ...
                <ul class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                    <li class="flex items-start gap-2">
                        <LuCheckCircle2 class="w-3.5 h-3.5 text-indigo-400 shrink-0 mt-0.5" />
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">plenary</code>
                            Plenary Hall (large capacity)[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">training_room</code>
                            Training Room (medium capacity)[cite: 5]
                        </li>
                        <li class="flex items-center gap-2">
                            <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-indigo-600 dark:text-indigo-400">mph</code>
                ...
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <p class="text-xs font-medium text-slate-700 dark:text-slate-300 leading-relaxed">Expected attendees must be between 1 and 5000[cite: 5]. This helps administrators allocate the appropriate venue[cite: 5].</p>
                </div>
            </div>
            ...
            <div class="bg-indigo-50/50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl p-5 shadow-sm">
                ...
                <p class="text-xs font-medium text-slate-600 dark:text-slate-400 mb-3">
                    Navigate to
                    <code class="font-mono bg-white dark:bg-slate-800 px-1 py-0.5 rounded shadow-sm text-indigo-500">/rental/venue</code>
                    to access the guest form. No authentication required[cite: 5].
                </p>
                <ul class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                    <li class="flex items-start gap-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-3.5 text-xs font-medium text-slate-600 dark:text-slate-400">
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-sky-500">GET</code>
                        ...
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-emerald-500">POST</code>
                            <code class="font-mono text-[0.7rem] text-slate-800 dark:text-slate-200">/api/rental/vehicles</code>
                            <br />
                        ...
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-amber-500">PUT</code>
                            <code class="font-mono text-[0.7rem] text-slate-800 dark:text-slate-200">/api/rental/vehicles/{id}</code>
                            <br />
                            <span class="text-[0.65rem] text-slate-500 ml-10 block mt-1">Update rental details[cite: 5]</span>
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-rose-500">DEL</code>
                            <code class="font-mono text-[0.7rem] text-slate-800 dark:text-slate-200">/api/rental/vehicles/{id}</code>
                            <br />
                ...
                <div class="space-y-6">
                    <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                        ...
                        <p class="text-xs font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                            ...
                            <code class="font-mono text-indigo-500 bg-white dark:bg-slate-800 px-1 py-0.5 rounded border border-slate-200 dark:border-slate-700">/api/rental/venues</code>
                    ...
                    <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                        ...
                        <ul class="space-y-2.5 text-xs font-medium text-slate-700 dark:text-slate-300">
                            <li class="flex items-center gap-2">
                                <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-emerald-600 dark:text-emerald-400 shadow-sm">200</code>
                                OK (GET, PUT, DELETE)[cite: 5]
                            </li>
                            <li class="flex items-center gap-2">
                                <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-emerald-600 dark:text-emerald-400 shadow-sm">201</code>
                                Created (successful POST)[cite: 5]
                            </li>
                            <li class="flex items-center gap-2">
                                <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-rose-600 dark:text-rose-400 shadow-sm">404</code>
                                Not Found (invalid resource ID)[cite: 5]
                            </li>
                            <li class="flex items-center gap-2">
                                <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-amber-600 dark:text-amber-400 shadow-sm">409</code>
                                Conflict (double-booking attempt)[cite: 5]
                            </li>
                            <li class="flex items-center gap-2">
                                <code class="px-1.5 py-0.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold text-amber-600 dark:text-amber-400 shadow-sm">422</code>
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    <h3 class="text-[0.65rem] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-4 flex items-center gap-1.5">
                        <LuCar class="w-3.5 h-3.5" />
                        Vehicle Validation
                    </h3>
                    <ul class="space-y-3 text-xs font-medium text-slate-600 dark:text-slate-400">
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">vehicle_type</code>
                            Required, must be: innova, pickup, van, or suv[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">date_from</code>
                            Required, must be today or future[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">date_to</code>
                            Required, must be same or after date_from[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">time_from</code>
                            Required, 24-hour format (HH:mm)[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">time_to</code>
                            Required, must be after time_from[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">purpose</code>
                            Required, max 500 characters[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">requested_by</code>
                            Required, max 255 characters[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">contact_number</code>
                            Required, valid phone number format[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-slate-500">notes</code>
                ...
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-3 text-xs font-medium text-slate-600 dark:text-slate-400">
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">venue_type</code>
                        ...
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">expected_attendees</code>
                            Required, must be 1-5000[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">event_name</code>
                            Required, max 255 characters[cite: 5]
                        </li>
                        <li>
                            <code class="px-1.5 py-0.5 mr-1.5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.65rem] font-semibold shadow-sm text-indigo-600 dark:text-indigo-400">requested_by</code>
            ...
            <div class="bg-amber-50/50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 rounded-xl p-5 shadow-sm">
                ...
                <ul class="space-y-2 text-xs font-medium text-slate-700 dark:text-slate-300 ml-1">
                    <li class="flex items-start gap-2">
                        <LuCheckCircle2 class="w-3.5 h-3.5 text-amber-500 shrink-0 mt-0.5" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-indigo-50/50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl p-5 shadow-sm">
                    ...
                    <p class="text-xs font-medium text-slate-700 dark:text-slate-300 mb-3 leading-relaxed">
                        The
                        <code class="font-mono text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 px-1 py-0.5 rounded shadow-sm border border-slate-200 dark:border-slate-700">RentalHostel</code>
                ...
                <div class="space-y-6">
                    <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                        <h3 class="text-[0.65rem] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-3.5 flex items-center gap-1.5">
                            <LuCalendarDays class="w-3.5 h-3.5" />
                            Calendar Module (Planned)
                        </h3>
                        <p class="text-xs font-medium text-slate-700 dark:text-slate-300 mb-3 leading-relaxed">A unified calendar view showing[cite: 5]:</p>
                        <ul class="space-y-2 text-xs font-medium text-slate-700 dark:text-slate-300 ml-1">
                            <li class="flex items-center gap-2.5">
                                <LuCheckCircle2 class="w-4 h-4 text-slate-400 shrink-0" />
