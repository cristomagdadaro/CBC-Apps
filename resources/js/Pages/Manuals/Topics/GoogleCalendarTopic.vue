                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-emerald-50/50 dark:bg-emerald-500/5 border border-emerald-100 dark:border-emerald-500/20 rounded-xl p-5 shadow-sm">
                        <h3 class="text-[0.65rem] font-semibold uppercase tracking-widest text-emerald-600 dark:text-emerald-400 mb-3.5 flex items-center gap-1.5">
                            <LuListChecks class="w-3.5 h-3.5" />
                            What this integration does
                        </h3>
                        <ul class="space-y-2.5 text-xs font-medium text-slate-700 dark:text-slate-300 ml-1">
                            <li class="flex items-start gap-2.5">
                                <LuCheckCircle2 class="w-3.5 h-3.5 text-emerald-500 shrink-0 mt-0.5" />
                        ...
                        <ul class="space-y-2.5 text-xs font-medium text-slate-700 dark:text-slate-300 ml-1">
                            ...
                            <li class="flex items-start gap-2.5">
                                ...
                                <span>
                                    ...
                                    <code class="px-1 py-0.5 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.6rem]">oauth</code>
                                    authentication.
                                </span>
                            </li>
                            <li class="flex items-start gap-2.5">
                ...
                <div class="space-y-6">
                    <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                        ...
                        <ol class="space-y-2.5 text-xs font-medium text-slate-600 dark:text-slate-300 list-decimal list-inside ml-1">
                            <li>
                                ...
                                <code class="px-1.5 py-0.5 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[0.6rem]">pin.dacbc@gmail.com</code>
                                .
                            </li>
                            <li>
                    ...
                    <div class="bg-amber-50/50 dark:bg-amber-500/5 border border-amber-100 dark:border-amber-500/20 rounded-xl p-5 shadow-sm">
                        ...
                        <ul class="space-y-2.5 text-xs font-medium text-slate-600 dark:text-slate-300 ml-1">
                            ...
                            <li class="flex items-start gap-2.5">
                                <div class="w-1.5 h-1.5 rounded-full bg-amber-400 mt-1 shrink-0"></div>
                                <span class="text-rose-600 dark:text-rose-400 font-semibold">If missing, Google returns 404 Not Found during sync.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <ol class="space-y-1.5 text-xs font-medium text-slate-600 dark:text-slate-300 list-decimal list-inside ml-1 mb-3">
                            ...
                            <li>
                                ...
                                <code class="font-mono text-[0.6rem] bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded border border-slate-200 dark:border-slate-700">storage/app/google-calendar/oauth-credentials.json</code>
                                .
                            </li>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-indigo-50/50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl p-5 shadow-sm">
                    <h4 class="text-[0.65rem] font-semibold uppercase tracking-widest text-indigo-600 dark:text-indigo-400 mb-3 flex items-center gap-1.5">
                        <LuLinkIcon class="w-3.5 h-3.5" />
                        1. Connect Google Calendar
                    </h4>
                    <p class="text-xs font-medium text-slate-600 dark:text-slate-400 mb-3 leading-relaxed">
                        Go to
                        <code class="font-mono text-[0.6rem] bg-white dark:bg-slate-800 px-1 py-0.5 rounded shadow-sm border border-slate-200 dark:border-slate-700">/apps/rentals/calendar</code>
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2.5 text-xs font-medium text-slate-600 dark:text-slate-300 ml-1">
                        <li class="flex items-start gap-2.5">
                            <div class="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1 shrink-0"></div>
                            <span>
            ...
            <div class="bg-sky-50/50 dark:bg-sky-500/10 border border-sky-100 dark:border-sky-500/20 rounded-xl p-5 shadow-sm flex items-start gap-3">
                ...
                <p class="text-xs font-medium text-sky-800 dark:text-sky-300 leading-relaxed">Public users do not need OneCBC accounts to subscribe, but the Google Calendar itself must be shared appropriately in Google Calendar settings.</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-4">
                    <h4 class="text-[0.65rem] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400 ml-1 flex items-center gap-1.5">
                        <LuServerCrash class="w-3.5 h-3.5" />
                        Common Issues
                    </h4>
                    ...
                    <div class="bg-rose-50/50 dark:bg-rose-500/5 border border-rose-100 dark:border-rose-500/20 rounded-xl p-4 shadow-sm">
                        ...
                        <p class="text-[0.65rem] font-medium text-rose-700/80 dark:text-rose-300/80 leading-relaxed">The connected Google account cannot access the configured calendar ID. Verify the calendar exists, the ID is correct, and the OAuth account has permission to that calendar.</p>
                    </div>
                    ...
                    <div class="bg-amber-50/50 dark:bg-amber-500/5 border border-amber-100 dark:border-amber-500/20 rounded-xl p-4 shadow-sm">
                        ...
                        <p class="text-[0.65rem] font-medium text-amber-700/80 dark:text-amber-300/80 leading-relaxed">OAuth only proves the token is valid. It does not grant access to every calendar automatically. Share the target calendar with the connected account.</p>
                    </div>
                    ...
                    <div class="bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-700/60 rounded-xl p-4 shadow-sm">
                        ...
                        <p class="text-[0.65rem] font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                            ...
                            <code class="font-mono bg-white dark:bg-slate-800 px-1 py-0.5 rounded border border-slate-200 dark:border-slate-700">storage/app/google-calendar/</code>
