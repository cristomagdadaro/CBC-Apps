...
<template>
    <app-layout title="Options Module">
        ...
        <div class="default-container pt-5">
            <section class="transition-colors p-3 md:p-6">
                <div class="mb-5 flex flex-col gap-3 border-b border-slate-200 pb-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 class="mt-2 text-2xl font-semibold text-slate-900">System Options</h2>
                        <p class="mt-2 text-sm text-slate-600">Configure system settings, manage module access, and toggle core workflows from the controls tab. The options tab provides a comprehensive view of all configurable options across modules.</p>
                    </div>
                </div>
                ...
                <TabNavigation v-model="activeTab" :tabs="optionTabs">
                    <template #default="{ activeKey }">
                        <div
                            ...
                            class="rounded-b-xl shadow-sm dark:bg-gray-800 space-y-6 p-3"
                        >
                        ...
                        'border-indigo-500 dark:border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20': workflowToggles.event_workflow_enabled,
                            ...
                            : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'"
                                            >
                                                <LuCheckCircle v-if="workflowToggles.event_workflow_enabled"
                                                               class="w-5 h-5"/>
                        ...
                        'border-indigo-500 dark:border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20': workflowToggles.participant_workflow_enabled,
                            ...
                            : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400'"
                                            >
                                                <LuCheckCircle v-if="workflowToggles.participant_workflow_enabled"
                                                               class="w-5 h-5"/>
                                                <LuXCircle v-else class="w-5 h-5"/>
                                            </div>
                                            <div>
                                ...
                                <div class="flex items-start justify-between gap-4 mb-6">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                                Configure deployment visibility and runtime mode for each module.
                                                Deployment access applies to the module's web pages and APIs
                                                together.
                                            </p>
                                            <div
                            ...
                            Internet: {{ deploymentAccessMeta.internet_url }}
                                ...
                                <div v-else class="grid grid-cols-1 xl:grid-cols-2 gap-5">
                                    <section
                                        ...
                                        :key="section.key"
                                        class="rounded-xl dark:bg-gray-900/30 p-4"
                                    >
                                        <div class="mb-4">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            >
                                                <div
                                                    class="grid grid-cols-3 grid-rows-2 gap-4 lg:flex-row lg:items-start lg:justify-between">
                                                    <div class="flex items-center col-span-3">
                                                        ...
                                                        <div
                                                            class="grid col-span-2 w-full shrink-0 gap-3 md:w-[22rem] md:grid-cols-2">
                                                            <div>
                                                                <label
                                                            ...
                                                            >
                                                                This module cannot be deactivated from the admin UI to
                                                                avoid locking out system settings.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 col-span-3">
                                                        {{ item.description }}
                                                    </p>
                                                </div>
