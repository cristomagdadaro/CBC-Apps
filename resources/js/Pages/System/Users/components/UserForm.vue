...
<template>
    <div>
        <form
            ...
            class="space-y-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 p-6 md:p-8">
            <!-- Header Section -->
            <div class="flex flex-col gap-5 border-b border-slate-100 dark:border-slate-800/60 pb-6 md:flex-row md:items-start md:justify-between">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <p class="text-[0.65rem] font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400 mb-1">Access Control</p>
            ...
            <div class="grid gap-6 xl:grid-cols-2">
                ...
                <div class="space-y-4">
                    ...
                    <section class="rounded-xl border border-slate-200/60 dark:border-slate-700/60 bg-slate-50/50 dark:bg-slate-800/30 p-5 shadow-sm h-full">
                        <p class="mb-5 text-xs font-medium text-slate-500 dark:text-slate-400 leading-relaxed">Roles apply the predefined permission bundles from the RBAC configuration.</p>
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <div class="mb-3.5 flex items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800/60 pb-3">
                                    ...
                                    <span class="text-[0.6rem] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md">{{ group.permissions.length }} perm{{ group.permissions.length === 1 ? "" : "s" }}</span>
                                </div>
