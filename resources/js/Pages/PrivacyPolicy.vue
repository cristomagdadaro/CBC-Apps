...
<template>
    ...
    <div class="font-sans text-slate-900 dark:text-slate-100 antialiased min-h-screen bg-slate-50 dark:bg-slate-950">
        <div class="py-6 sm:py-12 px-3.5 sm:px-6 flex flex-col items-center justify-center min-h-screen">
            ...
            <div class="w-full max-w-4xl p-5 sm:p-10 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-xl rounded-2xl prose dark:prose-invert max-w-none text-xs sm:text-sm md:text-base leading-relaxed tracking-normal" v-html="policy" />
