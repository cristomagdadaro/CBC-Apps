<template>
        <Head title="Google Calendar View" />
        <div class="h-screen w-full bg-gray-700 overflow-hidden">
...
<style>
/* Important: If this is a standalone page, 
   ensure the root elements don't have default padding/margin 
*/
html,
body,
#app {
