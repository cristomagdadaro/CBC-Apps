        ...
        <div class="flex flex-col gap-4 w-full">
            ...
            <div
                ...
                <div class="w-full mb-6">
                    <label class="block text-sm font-bold text-gray-900 dark:text-gray-100 mb-2">Search Bookings</label>
                    <input
                ...
                <div
                    v-if="loading"
                    class="text-sm text-gray-500 dark:text-slate-400 flex items-center gap-2 justify-center py-10">
