        ...
        <div class="p-5 pl-6">
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mb-3 line-clamp-1 text-xs text-gray-500 dark:text-slate-500">Requested by {{ formState.requested_by || "Unknown" }}</p>
                    ...
                    <div class="flex flex-wrap items-center gap-x-4 gap-y-2 rounded-lg border border-gray-100 bg-gray-50 p-2.5 text-xs text-gray-600 dark:border-slate-800 dark:bg-slate-800/50 dark:text-slate-400">
                        ...
                        <span
                            ...
                            class="flex items-center gap-1.5 border-l border-gray-300 pl-4 font-medium dark:border-slate-600">
            ...
            <div :class="['relative overflow-hidden border-b border-gray-200/50 px-6 py-5 dark:border-slate-700/50', statusConfig.header]">
                ...
                <div class="relative z-10 flex items-start justify-between">
                    <div>
                        ...
                        <h2 class="text-xl font-extrabold tracking-tight text-gray-900 dark:text-slate-100">Venue Rental Request</h2>
