...
<template>
    <Field
        ...
        @clear="onClear">
        <template #label-icon>
            <LuClock class="h-3.5 w-3.5 text-indigo-500 dark:text-indigo-400" />
        </template>
