...
<template>
    <Field
        ...
        <template #label-icon>
            <LuUsers class="h-3.5 w-3.5 text-indigo-500 dark:text-indigo-400" />
        </template>
                    ...
                    <div
                        ...
                        <div class="flex-1 overflow-y-auto py-1">
                            ...
                            <button
                                ...
                                :class="['flex w-full items-center gap-2 px-4 py-2 text-left text-sm transition-colors', selectedOption?.value === option.value ? 'bg-indigo-50 font-medium text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300' : 'text-slate-700 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800/50']">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
