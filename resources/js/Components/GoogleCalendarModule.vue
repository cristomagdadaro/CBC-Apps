        ...
        <section class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 p-6 md:p-8">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div class="space-y-3 flex-1">
                    ...
                    <p class="text-sm font-medium text-slate-500 dark:text-slate-400 leading-relaxed">{{ subtitle }} The browser only talks to internal Laravel endpoints. Calendar credentials stay on the server, and sync is limited to authenticated users.</p>
                </div>
                    ...
                    <div class="flex flex-wrap justify-between gap-5 text-xs font-medium opacity-90 shrink-0 whitespace-nowrap w-full">
                        <div class="flex items-start gap-3 w-fit whitespace-nowrap">
                            ...
                            <div>
                                ...
                                <p
                                    v-if="canStartOauthConnect && !googleMeta.configured"
                                    class="mt-2 text-[0.65rem] font-bold uppercase tracking-widest opacity-80 flex items-center gap-1.5">
            ...
            <aside class="space-y-6">
                ...
                <section class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 p-5">
                    <div class="flex items-center justify-between mb-5 border-b border-slate-100 dark:border-slate-800/60 pb-3">
                        ...
                        <span class="rounded-md bg-indigo-50 dark:bg-indigo-500/10 px-2 py-0.5 text-[0.6rem] font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-500/20 shadow-sm">{{ nextPortalEvents.length }} upcoming</span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <article
                            ...
                            <div class="flex items-start justify-between gap-3 mb-3">
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p
                                        v-if="event.subtitle"
                                        class="mt-1.5 text-xs font-medium text-slate-500 dark:text-slate-400 truncate">
                                        {{ event.subtitle }}
                                    </p>
                                </div>
                                <span :class="['rounded-md px-2 py-0.5 text-[0.6rem] font-bold uppercase tracking-widest border shadow-sm shrink-0', isSynced(event) ? 'bg-emerald-50 border-emerald-200 text-emerald-600 dark:bg-emerald-500/10 dark:border-emerald-500/30 dark:text-emerald-400' : 'bg-white border-slate-200 text-slate-500 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400']">
                        ...
                        <div
                            ...
                            class="flex flex-col items-center justify-center py-8 text-center border border-dashed border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50/50 dark:bg-slate-800/30">
                ...
                <section class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 p-5">
                    <div class="flex items-center justify-between mb-5 border-b border-slate-100 dark:border-slate-800/60 pb-3">
                        ...
                        <span class="rounded-md bg-sky-50 dark:bg-sky-500/10 px-2 py-0.5 text-[0.6rem] font-bold uppercase tracking-widest text-sky-600 dark:text-sky-400 border border-sky-100 dark:border-sky-500/20 shadow-sm">{{ googleEvents.length }} loaded</span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <article
                            ...
                            <p
                                ...
                                class="mt-2 text-[0.6rem] font-mono text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-900 px-2 py-1 rounded border border-slate-100 dark:border-slate-700/50 truncate">
                                <span class="font-semibold text-slate-500 dark:text-slate-400 mr-1">KEY:</span>
