    ...
    <Field
        ...
        <template #default="{ inputId, isInvalid, isValid, guideId }">
            <div class="relative w-full">
                ...
                <div
                    :id="inputId"
                    :class="['w-full flex gap-2 justify-between items-center rounded-xl px-3 py-2.5 transition-all duration-200', 'bg-transparent', disabled ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer', isInvalid ? '' : 'focus-within:ring-0']"
                    ...
                    <div class="flex gap-2 flex-wrap items-center flex-1">
                        <div
                            ...
                            class="text-slate-400 dark:text-slate-500 text-xs sm:text-sm">
                            {{ placeholder }}
                        </div>
                        <div
                            v-for="option in selectedOptions"
                            :key="option.value"
                            class="flex gap-1 items-center bg-indigo-100 dark:bg-indigo-500/20 text-indigo-800 dark:text-indigo-300 px-2 py-1 rounded-md text-xs font-medium">
                    ...
                    <div
                        ...
                        <div class="overflow-y-auto flex-1 py-1">
                            <div
                                ...
                                class="text-center text-slate-500 text-xs py-4">
                            ...
                            <label
                                ...
                                <span class="text-slate-700 dark:text-slate-300 text-xs sm:text-sm">
                                    {{ option.label }}
                                </span>
                            </label>
                        </div>
