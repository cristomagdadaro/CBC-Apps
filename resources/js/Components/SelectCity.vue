            ...
            <div class="relative w-full">
                <button
                    ...
                    :class="[
                        ...
                        (disabled || locationLoading || !cityOptions.length) ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50',
                ...
                <!-- Backdrop -->
                <div v-show="isOpen && cityOptions.length" class="fixed inset-0 z-40" @click.prevent="isOpen = false" />
