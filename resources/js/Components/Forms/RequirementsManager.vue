    ...
    computed: {
        ...
        systemFormTypeOptions() {
            return [
                ...
                {
                    value: "preregistration_biotech",
                    label: "Pre-registration + Quiz Bee",
                    isSystem: true,
                },
                {
                    value: "preregistration_quizbee",
                    label: "Pre-registration Quiz Bee",
                    isSystem: true,
                },
...
<template>
    <div class="flex flex-col gap-4">
        ...
        <transition-container type="slide-bottom">
            <div
                v-if="error || localErrors.requirements"
        ...
        <div class="space-y-4">
            <div
                ...
                <div class="flex flex-col justify-between gap-3 border-b border-slate-200/60 pb-3 sm:flex-row sm:items-center dark:border-slate-700/60">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <div
                            ...
                            :class="{ 'opacity-50': req.is_enabled === false }">
                            <button
                                type="button"
                ...
                <transition name="slide-down">
                    <InputError
                        v-if="localErrors[`req_${index}`]"
                        :message="localErrors[`req_${index}`]"
                        class="text-xs" />
                </transition>
                    ...
                    <div class="md:col-span-5">
                        ...
                        <select
                            ...
                            <option
                                value=""
                                disabled>
                                {{ loadingTemplates ? "Loading..." : "Select form type..." }}
                            </option>
                            ...
                            <optgroup
                                v-if="customFormTypeOptions.length"
                ...
                <div
                    ...
                    <datalist id="limit-field-options">
                        <option
                            v-for="opt in limitFieldOptions"
                            :key="opt.value"
                            :value="opt.value">
                            {{ opt.label }}
                        </option>
