    ...
    <div class="camera-scanner gap-2 flex flex-col" :class="[`variant-${variant}`]">
            ...
            <div v-if="showToggle" class="scanner-controls w-full">
                <button type="button" @click="toggleScanner" :disabled="!enabled"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-left" :class="!isOpen? '':'hidden md:block'">
                    ...
                    <div class="relative inline-flex h-7 w-12 items-center rounded-full transition-colors duration-300"
        ...
        <transition name="scanner-slide">
            <div v-show="isOpen"
                ...
                <!-- Active Scanner -->
                <QrcodeStream v-if="enabled && selectedDevice && isClient"
                    :constraints="{ deviceId: selectedDevice.deviceId }" :track="paintOutline" :formats="formats"
                    @error="onError" @detect="onDecode" class="w-full h-full object-cover" />
                ...
                <!-- Empty State -->
                <div v-else
                    class="absolute inset-0 flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800 text-center p-4">
