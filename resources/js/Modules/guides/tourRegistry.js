...
export const TOUR_REGISTRY = {
    ...
    steps: [
      ...
      },
      {
        ...
        popover: {
          ...
          description:
            "Each card opens a different service—rentals, event sign-ups, equipment requests, inventory checkout, and more.",
          side: "top",
          align: "center",
        },
      },
    ...
    steps: [
      ...
      },
      {
        ...
        popover: {
          ...
          description:
            "Click any available item to open the checkout form and request it.",
          side: "top",
          align: "center",
        },
      },
  ...
  "rental-bookings-public": {
    ...
    steps: [
      ...
      {
        element: "[data-guide='rental-calendar']",
        popover: {
