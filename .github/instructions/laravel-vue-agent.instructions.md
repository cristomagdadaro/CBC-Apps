...
This is a Laravel 10 application using Inertia.js with Vue 3 options API for a modern SPA experience. It manages event registrations, inventory tracking, and resource requests for an organization (CBC).
